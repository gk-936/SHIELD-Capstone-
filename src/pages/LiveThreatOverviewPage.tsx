...
export const LiveThreatOverviewPage: React.FC = () => {
  return (
    <div className="flex flex-col h-full bg-[#03050a] overflow-y-auto bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#081225] via-[#03050a] to-[#03050a]">
      <SystemStatusBar />
